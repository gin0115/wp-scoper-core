...
class HomeCommand extends AbstractMenuCommand {
	...
	public function getTableItems(): array {
		return array(
			array(
				'Alias'       => 's',
				'Command'     => 'status',
				'Description' => 'Show status of WP Scoper.',
				'action'      => 'status',
			),
			array(
				'Alias'       => 'p',
				'Command'     => 'patcher',
				'Description' => 'Global patchers, list, add and remove',
				'action'      => 'patcher',
			),
			array(
				'Alias'       => 'n',
				'Command'     => 'new',
				'Description' => 'Sets up a new WP Scoper project',
				'action'      => 'test',
			),
			array(
				'Alias'       => 'q',
				'Command'     => 'quit',
				'Description' => 'Quit WP Scoper.',
				'action'      => 'test',
			),
		);
	}
	...
	public function beforeMenu( SymfonyStyle $style ): void {
		StyleHelper::commandHeader( $style, array( 'Home' ), true );
	}
}
